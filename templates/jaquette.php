...
$query = "SELECT ucoll.coll_name, jeu.game_title, jeu.game_img, jeu.game_desc, 
          ...
          GROUP BY ucoll.coll_name, jeu.game_title, jeu.game_img, jeu.game_desc, puv.sell_price";
